...
require_once("FinderPatternFinder.php");
require_once("AlignmentPatternFinder.php");
require_once("\..\..\Common\DetectorResult.php");
require_once("\..\Decoder\BitMatrixParser.php");
