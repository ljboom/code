...
require_once("GDLuminanceSource.php");
require_once("Qrcode\QRCodeReader.php");
require_once("Qrcode\Decoder\Decoder.php");
require_once("Qrcode\Detector\Detector.php");
require_once("Common\HybridBinarizer.php");
