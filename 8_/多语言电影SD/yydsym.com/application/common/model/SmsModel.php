	...
	public function sendSMSCode($phone=''){
		...
		if(!$cache_code || !$code || $cache_code != $code ){
		    if($lang=='cn'){
		        ...
		        return ['code'=>0, 'code_dec'=>'The verification code has expired or the invitation code has not been filled in'];
		    }else{
		        return ['code'=>0, 'code_dec'=>'El código de verificación ha caducado o el código de invitación no se ha completado'];
		    }
		}
/*
