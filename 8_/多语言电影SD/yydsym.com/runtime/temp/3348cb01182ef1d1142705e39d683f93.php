<?php /*a:1:{s:84:"/www/wwwroot/video-shuadan.timibbs.vip/application/manage/view/base/notice_edit.html";i:1609314392;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <form class="layui-form layui-form-pane" action="">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" autocomplete="off" value="<?php echo htmlentities($data['title']); ?>" placeholder="请输入公告标题" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select name="gropid" lay-verify="required" lay-search="">
                                        ...
                                        <option value="<?php echo htmlentities($value['id']); ?>"<?php if($data['gropid'] == $value['id']): ?> selected="selected"<?php endif; ?>><?php echo htmlentities($value['group_name']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="url" value="<?php echo htmlentities($data['url']); ?>" autocomplete="off" placeholder="请输入公告链接" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-upload-drag cover_img">
                                    ...
                                    <p>点击上传，或将文件拖拽到此处</p>
                                    <div <?php if(!$data['cover_img']): ?>class="layui-hide"<?php endif; ?>>
                                        <hr>
                                        <img src="<?php echo isset($data['cover_img']) ? htmlentities($data['cover_img']) : ''; ?>" alt="上传成功后渲染" style="max-width: 150px">
                                        <p></p>
                                    </div>
                                </div>
                                <input type="hidden" name="cover_img" value="<?php echo isset($data['cover_img']) ? htmlentities($data['cover_img']) : ''; ?>" class="layui-input">
                            </div>
