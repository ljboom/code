<?php /*a:1:{s:83:"/www/wwwroot/video-shuadan.timibbs.vip/application/manage/view/base/group_list.html";i:1609314392;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['table'], function(){
        ...
        table.render({
            elem: '#groupList'
            ,title: '网站公告分类'
            ,url: '/manage/base/groupList'
            ,method: 'post'
            ,cols: [[
                {checkbox: true, fixed: true}
                ,{field:'group_name', title: '标题', sort: true}
        ...
        //监听排序事件
        table.on('sort(groupList)', function(obj){ //注：sort 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
