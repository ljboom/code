<?php /*a:1:{s:89:"/www/wwwroot/video-shuadan.timibbs.vip/application/manage/view/other/front_login_log.html";i:1609314392;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-row layui-col-space15">
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <table class="layui-hide" id="front_login_log" lay-filter="front_login_log"></table>
                </div>
            </div>
        </div>
    </div>
...
<script>
    layui.use(['table'], function(){
        ...
        //方法级渲染
        table.render({
            elem: '#front_login_log'
            ,title: '前台登录日志'
            ,url: '/manage/other/front_login_log'
            ,method: 'post'
            ,cols: [[
        ...
        //监听排序事件
        table.on('sort(front_login_log)', function(obj){ //注：sort 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            //尽管我们的 table 自带排序功能，但并没有请求服务端。
            //有些时候，你可能需要根据当前排序的字段，重新向服务端发送请求，从而实现服务端排序，如：
            table.reload('front_login_log', {
