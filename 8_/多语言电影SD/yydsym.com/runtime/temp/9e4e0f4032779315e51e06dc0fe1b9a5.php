<?php /*a:1:{s:84:"/www/wwwroot/video-shuadan.timibbs.vip/application/manage/view/base/admins_edit.html";i:1609314392;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <form class="layui-form layui-form-pane" action="">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="username" value="<?php echo htmlentities($data['username']); ?>" autocomplete="off" placeholder="请输入管理员账号" class="layui-input">
                                </div>
