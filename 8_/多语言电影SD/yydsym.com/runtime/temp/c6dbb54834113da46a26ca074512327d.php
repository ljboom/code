<?php /*a:1:{s:82:"/www/wwwroot/video-shuadan.timibbs.vip/application/manage/view/user/team_move.html";i:1609314392;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <table class="layui-table" lay-even="" lay-skin="row">
                        ...
                        <tbody>
                            <?php if($teammoveLog): foreach($teammoveLog as $key=>$value): ?>
                            <tr>
                                <td><?php echo htmlentities($value['username']); ?></td>
                                <td><?php echo htmlentities($value['log']); ?></td>
                                <td><?php echo htmlentities($value['addtime']); ?></td>
                            </tr>
                            <?php endforeach; else: ?>
                            <tr>
