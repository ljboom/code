<?php /*a:1:{s:82:"/www/wwwroot/video-shuadan.timibbs.vip/application/manage/view/activity/lists.html";i:1609314392;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['table'], function(){
        ...
        table.render({
            elem: '#activityList'
            ,title: '活动列表'
            ,url: '/manage/activity/lists'
            ,method: 'post'
            ,cols: [[
                {checkbox: true, fixed: true}
                ,{field: 'title', title: '活动标题', sort: true, fixed: 'left'}
        ...
        //监听排序事件
        table.on('sort(activityList)', function(obj){ //注：sort 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
