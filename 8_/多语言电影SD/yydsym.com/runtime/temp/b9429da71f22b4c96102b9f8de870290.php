<?php /*a:1:{s:82:"/www/wwwroot/video-shuadan.timibbs.vip/application/manage/view/user/user_list.html";i:1658188494;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card" style="padding: 10px;">
                <form class="layui-form search">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label">提现翻倍</label>
                            <div class="layui-input-inline">
                                <select name="is_double" lay-search="">
                                    <option value="0">全部</option>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="vip_level" lay-search="">
                                    <option value="0">全部</option>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="state" lay-search="">
                                    <?php foreach(app('config')->get('custom.userState') as $key=>$value): ?>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input class="layui-input" name="last_ip" autocomplete="off">
                            </div>
                        </div>
...
<script type="text/html" id="lockAccount">
    <input type="checkbox" name="lockAccount" value="{{d.id}}" lay-skin="switch" lay-text="是|否" lay-filter="userAction"
           data-suburi="lockAccount" {{ d.state== 2 ? 'checked' : '' }}>
</script>
<script type="text/html" id="danger">
    <input type="checkbox" name="danger" value="{{d.id}}" lay-skin="switch" lay-text="是|否" lay-filter="userAction"
           data-suburi="risk" {{ d.danger== 1 ? 'checked' : '' }}>
</script>
...
<script type="text/html" id="vip_level">
    @{{# if (d.vip_level == 1 { }}
    <span style="color:#89deb3;">实习会员</span>
    @{{# } else if (d.vip_level == 2) { }}
    <span style="color:#d67a7a;">VIP1</span>
    @{{# } else { }}
    <span class="layui-badge-rim">实习会员</span>
    @{{# } }}
</script>
    ...
    layui.use(['table'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'username', title: '账号', width: 150, sort: true, fixed: 'left'}
                //, {field: 'uid', title: 'UID', sort: true}
                , {field: 'team_username', title: '代理线', sort: true}
                , {field: 'chongzhi', title: '总充值', sort: true}
                , {field: 'tixian', title: '总提现', sort: true}
                //,{title: '等级', templet: '#vip_level', unresize: true}
                , {
                    field: 'vname', title: '等级', templet: function (d) {
                        if (d.vip_level == 1) {
                            return "实习会员";
                        } else if (d.vip_level == 2) {
                            return "VIP1";
                            ...
                            return "VIP4";
                        } else if (d.vip_level == 6) {
                            return "VIP5";
                        } else if (d.vip_level == 7) {
                            return "VIP6";
                        } else if (d.vip_level == 8) {
                            return "VIP7";
                        } else if (d.vip_level == 9) {
                            return "VIP8";
                        } else if (d.vip_level == 10) {
                            return "VIP9";
                        }
                    }
                }

                //         templet: '<div>@{{data1.name}}</div>'
                //      }
                , {field: 'balance', title: '余额', sort: true, totalRow: true}
                , {field: 'shouyibao', title: '收益宝余额', sort: true, totalRow: true}
                ...
                , {
                    ...
                    field: 'state', title: '提现翻倍', sort: true, templet: function (d) {
                        return d.is_double==1 ? '翻倍' : '-';
                    }
                }
                , {field: 'credit', title: '信用值', sort: true}
                , {field: 'zcip', title: '注册IP',width:150, sort: false}
                , {field: 'reg_time', title: '注册时间',width:150, sort: false}
                , {field: 'last_ip', title: '最后登录IP', width: 150, sort: false}
            ...
            search: function () {
                ...
                table.reload('userList', {
                    ...
                    , where: {
                        ...
                        , last_ip: $("input[name='last_ip']").val()
                        , vip_level: $("select[name='vip_level']").val()
                        , is_double: $("select[name='is_double']").val()
