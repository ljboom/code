<?php /*a:7:{s:69:"/www/wwwroot/test.dkewl.com/application/admin/view/attachment/index.html";i:1618724626;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
                                ...
                                <div class="search-bar row">
                                    ...
                                    <div class="input-group col-sm-5">
                                        <div class="input-group-prepend">
                                            ...
                                            <?php switch(input('get.filetype')): case "1": ?>图片<?php break; case "2": ?>文件<?php break; case "3": ?>音频<?php break; case "4": ?>视频<?php break; case "5": ?>flashs<?php break; default: ?>文件种类
                                            <?php endswitch; ?>
                                            </button>
                                            <input type="hidden" name="filetype" value="<?php echo input('get.filetype'); ?>" />
                                        ...
                                        <div class="input-group-prepend">
                                            <button data-toggle="dropdown" class="btn btn-white dropdown-toggle" type="button" aria-expanded="false">
                                            <?php switch(input('get.type')): case "1": ?>ID<?php break; case "2": ?>名称<?php break; default: ?>不限
                                            <?php endswitch; ?>
                                            </button>
                                    ...
                                    <div class="input-group input-daterange col-sm-5">
                                        <input id="data_start" name="data_start" type="text" placeholder="创建日期(起)"
                                            ...
                                            value="<?php echo input('get.data_start'); ?>" />
                                        <div class="input-group-addon"> ~ </div>
                                        <input id="data_end" name="data_end" type="text" placeholder="创建日期(止)"
                                            data-date-format="yyyy-mm-dd" class="form-control"
                                            value="<?php echo input('get.data_end'); ?>" />
                                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="toolbar-btn-action">
                                ...
                                <a title="删除" class="btn btn-danger ajax-post confirm" target-form="ids"
                                    href="<?php echo url('admin/attachment/delete'); ?>"><i
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="align-middle"><input type="checkbox" class="i-checks ids" name="ids[]"
                                            value="<?php echo htmlentities($data['id']); ?>"></td>
                                    <td class="align-middle"><?php echo htmlentities($data['id']); ?></td>
                                    <td class="align-middle">
                                        <a href="<?php echo !empty($data['thumb']) ? htmlentities($data['thumb']) : htmlentities($data['path']); ?>" data-gallery=""><img
                                                src="<?php echo !empty($data['thumb']) ? htmlentities($data['thumb']) : htmlentities($data['path']); ?>"
                                                style="max-height:90px;max-width:120px"></a>
                                    </td>
                                    <td class="align-middle">
                                        <a href="<?php echo !empty($data['thumb']) ? htmlentities($data['thumb']) : htmlentities($data['path']); ?>"
                                            class="btn btn-primary p-xxs b-r-sm"><?php echo !empty($data['thumb']) ? htmlentities($data['thumb']) : htmlentities($data['path']); ?></a>
                                    </td>
                                    <td class="align-middle"><?php echo htmlentities($data['ext']); ?></td>
                                    <td class="align-middle"><?php echo htmlentities($data['size']); ?></td>
                                    <td class="align-middle"><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($data['create_time'])? strtotime($data['create_time']) : $data['create_time'])); ?></td>
                                    <td class="align-middle tooltip-demo">
                                        <a href="<?php echo url('admin/attachment/delete?id='.$data['id']); ?>"
