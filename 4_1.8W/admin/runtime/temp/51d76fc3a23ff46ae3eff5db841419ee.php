<?php /*a:7:{s:64:"/www/wwwroot/test.dkewl.com/application/admin/view/order/index.html";i:1619698836;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
							...
							<table class="table table-bordered table-hover">
							 ...
							 <?php foreach($list as $v): ?>
							        <tr>
							            ...
							            <td class="align-middle"><?php if(($v['status'] == 1)): ?> 正常<?php else: ?>收益结束<?php endif; ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['worth']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['add_worth']); ?></td>
							             <td class="align-middle"><?php echo htmlentities($v['trustee'] + $v['service'] + $v['worth']); ?></td>
							            <td class="align-middle">
							     <!--           <a href="<?php echo url('admin/users/useredit?id='.'1'); ?>" class="btn btn-primary btn-xs"-->
												<!--_tag="edit" data-toggle="tooltip" data-placement="top" title="修改"><i-->
												<!--	class="fa fa-pencil"></i></a>-->
													
							               		<?php if($v['status']==1): ?>
												<a href="<?php echo url('admin/order/editStatus?id='.$v['id'].'&type=2'); ?>"
													class="btn btn-warning btn-xs ajax-get confirm" _tag="disable"
													data-toggle="tooltip" data-placement="top" title="停止收益"><i class="fa fa-close">停止收益</i></a>
												<?php else: ?>
												<a href="<?php echo url('admin/order/editStatus?id='.$v['id'].'&type=1'); ?>" class="btn btn-success btn-xs ajax-get confirm"
													_tag="enable" data-toggle="tooltip" data-placement="top" title="启用"><i class="fa fa-check">启用</i></a>
												<?php endif; ?>
							            </td>
							        </tr>
							    <?php endforeach; ?>
