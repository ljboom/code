<?php /*a:7:{s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/users/feedback.html";i:1620300726;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
							...
							<div class="col-sm-12">
								<div class="toolbar-btn-action">
									...
									<a title="审核通过" class="btn btn-success ajax-post confirm" target-form="ids"
										href="<?php echo url('admin/order/recharge_editStatus?type=2'); ?>"><i
											class="fa fa-check-circle-o"></i> 审核通过</a>
									<a title="审核驳回" class="btn btn-warning ajax-post confirm" target-form="ids"
										href="<?php echo url('admin/order/recharge_editStatus?type=3'); ?>"><i
							...
							<table class="table table-bordered table-hover">
							 ...
							 <?php foreach($list as $v): ?>
							        <tr>
							            ...
							            <td class="align-middle"><?php echo htmlentities($v['relation']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['voucher']); ?></td>
							             <td class="align-middle"><?php echo htmlentities($v['createtime']); ?></td>
							            <td class="align-middle"><?php if(($v['checktime'] == null)): ?>未处理<?php else: ?><?php echo date('Y-m-d H:i:s',$v['checktime']);?><?php endif; ?></td>
							           <td class="align-middle">
							            ...
							            <td class="align-middle">
							               		...
							               		<?php if($v['status']==1): ?>
												<a href="<?php echo url('admin/order/recharge_editStatus?id='.$v['id'].'&type=3'); ?>"
													...
													data-toggle="tooltip" data-placement="top" title="审核通过"><i class="fa fa-close">驳回审核</i></a>
														...
														<a href="<?php echo url('admin/order/recharge_editStatus?id='.$v['id'].'&type=2'); ?>" class="btn btn-success btn-xs ajax-get confirm"
