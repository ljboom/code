<?php /*a:7:{s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/role/index.html";i:1618724626;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox-content m-b-sm border-bottom">
                <div class="p-xs">
                    ...
                    <h2>系统角色管理</h2>
                    <span>角色组可以有多个,角色有上下级层级关系,如果子角色有角色组和管理员的权限则可以派生属于自己组别的下级角色组或管理员。</span>
                </div>
            </div>
                    ...
                    <div class="row m-b">
                        <div class="col-sm-12">
                            <div class="toolbar-btn-action">
                                ...
                                <a title="添加" class="btn btn-success" href="<?php echo url('admin/role/add'); ?>"><i
                                        class="fa fa-plus-circle"></i> 添加</a>
                                <a title="删除" class="btn btn-danger ajax-post confirm" target-form="ids"
                                    href="<?php echo url('admin/role/delete'); ?>"><i
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="align-middle"><?php if($vo['id']!=1): ?><input type="checkbox" class="i-checks ids" name="ids[]" value="<?php echo htmlentities($vo['id']); ?>"><?php endif; ?></td>
                                    <td class="align-middle"><?php echo htmlentities($vo['id']); ?></td>
                                    <td class="align-middle"><?php echo $vo['title_display']; ?></td>
                                    ...
                                    <td class="align-middle tooltip-demo">
                                        ...
                                        <a href="<?php echo url('admin/role/editStatus?id='.$vo['id'].'&type=2'); ?>"
                                            class="btn btn-warning btn-xs ajax-get confirm" _tag="disable"
                                            data-toggle="tooltip" data-placement="top" title="禁用"><i
                                                class="fa fa-close"></i></a>
                                        <?php else: ?>
                                        <a href="<?php echo url('admin/role/editStatus?id='.$vo['id'].'&type=1'); ?>"
                                            class="btn btn-success btn-xs ajax-get confirm" _tag="enable"
                                            data-toggle="tooltip" data-placement="top" title="启用"><i
                                                class="fa fa-check"></i></a>
                                        <?php endif; ?>
                                        <a href="<?php echo url('admin/role/edit?id='.$vo['id']); ?>" class="btn btn-primary btn-xs" _tag="edit"
                                            data-toggle="tooltip" data-placement="top" title="修改"><i
                                                class="fa fa-pencil"></i></a>
                                        <a href="<?php echo url('admin/role/delete?id='.$vo['id']); ?>"
