<?php /*a:7:{s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/database/index.html";i:1618724626;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
								...
								<div class="row m-b">
									<div class="col-sm-12">
										<div class="toolbar-btn-action">
											...
											<a href="<?php echo url('admin/database/export'); ?>" title="立即备份" class="btn btn-success ajax-post confirm" target-form="ids" ><i class="fa fa-check-circle-o"></i> 立即备份</a>
											<a href="<?php echo url('admin/database/repairTable'); ?>" title="优化表" class="btn btn-primary ajax-post confirm" target-form="ids" ><i class="fa fa-cogs"></i> 优化表</a>
											<a href="<?php echo url('admin/database/optimizeTable'); ?>" title="修复表" class="btn btn-primary ajax-post confirm" target-form="ids" ><i class="fa fa-wrench"></i> 修复表</a>
										</div>
									</div>
								</div>
								...
								<div class="table-responsive">
									<table class="table table-bordered table-hover">
										...
										<tbody>
											...
											<tr>
												<td><input type="checkbox" class="i-checks ids" name="ids[]" value="<?php echo htmlentities($vo['Name']); ?>"></td>
												<td><?php echo htmlentities($vo['Name']); ?></td>
												<td><?php echo htmlentities($vo['Rows']); ?></td>
												<td><?php echo intval( $vo['Data_length']/pow(2,10) ); ?>kB</td>
												<td><?php echo htmlentities($vo['Data_free']); ?>B</td>
												<td><?php echo htmlentities($vo['Comment']); ?></td>
												<td class="tooltip-demo">
													<a href="<?php echo url('admin/database/repairTable?id='.$vo['Name']); ?>" class="btn btn-primary btn-xs ajax-get confirm" data-toggle="tooltip" data-placement="top" title="优化表"><i class="fa fa-cogs"></i></a>
													<a href="<?php echo url('admin/database/optimizeTable?id='.$vo['Name']); ?>" class="btn btn-primary btn-xs ajax-get confirm" data-toggle="tooltip" data-placement="top" title="修复表"><i class="fa fa-wrench"></i></a>
												</td>
											</tr>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</tbody>
									...
									<table class="table table-bordered table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo htmlentities($vo['size']); ?>KB</td>
												<td><?php echo htmlentities($vo['time']); ?></td>
												<td class="tooltip-demo">
													<a href="<?php echo url('admin/database/import?id='.$vo['id']); ?>" class="btn btn-primary btn-xs ajax-get confirm" data-toggle="tooltip" data-placement="top" title="还原"><i class="fa fa-reply"></i></a>
													<a href="<?php echo url('admin/database/delete?id='.$vo['id']); ?>" class="btn btn-danger btn-xs ajax-get confirm"  data-toggle="tooltip" data-placement="top" title="删除"><i class="fa fa-trash"></i></a>
												</td>
											</tr>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</tbody>
