<?php /*a:7:{s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/order/sellout.html";i:1621044794;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
									...
									<div class="search-bar row">
										...
										<div class="input-group col-sm-5">
											<div class="input-group-prepend">
												...
												<?php switch(input('get.status')): case "1": ?>未审核<?php break; case "2": ?>审核通过<?php break; case "3": ?>审核驳回<?php break; default: ?>全部状态
												<?php endswitch; ?>
												</button>
												...
												<ul class="dropdown-menu" x-placement="bottom-start"
													...
													<li>
														...
														<a class="search-dropdown" data-value="1"
															href="javascript:void(0)" data-name="status">未审核</a>
													</li>
													<li>
														<a class="search-dropdown" data-value="2"
															href="javascript:void(0)" data-name="status">审核通过</a>
													</li>
													<li>
														<a class="search-dropdown" data-value="3"
															href="javascript:void(0)" data-name="status">审核驳回</a>
													</li>
											...
											<div class="input-group-prepend">
												<button data-toggle="dropdown" class="btn btn-white dropdown-toggle" type="button" aria-expanded="false">
													<?php switch(input('get.type')): case "1": ?>订单号<?php break; case "2": ?>用户名<?php break; case "3": ?>昵称<?php break; case "4": ?>邮箱<?php break; default: ?>不限
													<?php endswitch; ?>
												</button>
						...
						<div class="row m-b">
							<div class="col-sm-12">
								<div class="toolbar-btn-action">
									...
									<a title="审核通过" class="btn btn-success ajax-post confirm" target-form="ids"
										href="<?php echo url('admin/order/sellout_editStatus?type=2'); ?>"><i
											class="fa fa-check-circle-o"></i> 审核通过</a>
									<a title="审核驳回" class="btn btn-warning ajax-post confirm" target-form="ids"
										href="<?php echo url('admin/order/sellout_editStatus?type=3'); ?>"><i
											class="fa fa-ban"></i> 审核驳回</a>
							...
							<table class="table table-bordered table-hover">
							 ...
							 <?php foreach($list as $v): ?>
							        <tr>
							            ...
							            <td class="align-middle"><?php echo htmlentities($v['money']); ?></td>
							            <td>
							                <?php if(($v['bank_id'] == 2)): ?>卖出到钱包<?php else: ?>
							                开户名:<?php echo htmlentities($v['name']); ?></br>
							                身份证号:<?php echo htmlentities($v['number']); ?></br>
							                开户行:<?php echo htmlentities($v['opening_bank']); ?></br>
							                银行卡号:<?php echo htmlentities($v['bank_card']); ?></br>
							               手机号码:<?php echo htmlentities($v['phone']); ?><?php endif; ?>
							            </td>
							            <td class="align-middle"><?php echo date('Y-m-d H:i:s',$v['createtime']);?></td>
							            <td class="align-middle"><?php if(($v['disposetime'] == null)): ?>未处理<?php else: ?><?php echo date('Y-m-d H:i:s',$v['disposetime']);?><?php endif; ?></td>
							            <td class="align-middle">
							                   <?php echo htmlentities($v['o_id']); ?>
							             </td> 
							              <td class="align-middle">
							                   <?php if(($v['type'] == 3)): ?>卖出到钱包<?php else: ?>卖出到银行卡<?php endif; ?>
							             </td>
							           <td class="align-middle">
							               <?php if(($v['status'] == 1)): ?>
							               等待审核
							            ...
							            <td class="align-middle">
							               		...
							               		<?php if($v['status']==1): ?>
												<a href="<?php echo url('admin/order/sellout_editStatus?id='.$v['id'].'&type=3'); ?>"
													class="btn btn-warning btn-xs ajax-get confirm" _tag="disable"
													data-toggle="tooltip" data-placement="top" title="审核通过"><i class="fa fa-close">驳回审核</i></a>
													
														<a href="<?php echo url('admin/order/sellout_editStatus?id='.$v['id'].'&type=2'); ?>" class="btn btn-success btn-xs ajax-get confirm"
													_tag="enable" data-toggle="tooltip" data-placement="top" title="审核通过"><i class="fa fa-check">审核通过</i></a>
