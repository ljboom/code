<?php /*a:7:{s:68:"/www/wwwroot/test.dkewl.com/application/admin/view/auth_rule/index.html";i:1618724626;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
				        ...
				        <div class="col-lg-12">
				            ...
				            <div class="ibox-content m-b-sm border-bottom">
				                <div class="p-xs">
				                    ...
				                    <h2>权限节点管理</h2>
				                    <span>规则通常对应一个控制器的方法,同时左侧的菜单栏数据也从规则中体现,通常建议只给超级管理员使用。</span>
				                </div>
				            </div>
				                    ...
				                    <div class="row m-b">
				                        <div class="col-sm-12">
				                            <div class="toolbar-btn-action">
				                                ...
				                                <a title="添加" class="btn btn-success" href="<?php echo url('admin/auth_rule/add'); ?>"><i
				                                        class="fa fa-plus-circle"></i> 添加</a>
				                                <a title="排序" class="btn btn-success ajax-post confirm" target-form="sort"
				                                    target-form2="idsort"
				                                    href="<?php echo url('admin/auth_rule/editSort'); ?>"><i
				                                        class="fa fa-sort"></i> 排序</a>
				                                <a title="启用" class="btn btn-success ajax-post confirm" target-form="ids"
				                                    href="<?php echo url('admin/auth_rule/editStatus?type=1'); ?>"><i
				                                        class="fa fa-check-circle-o"></i> 启用</a>
				                                <a title="禁用" class="btn btn-warning ajax-post confirm" target-form="ids"
				                                    href="<?php echo url('admin/auth_rule/editStatus?type=2'); ?>"><i
				                                        class="fa fa-ban"></i> 禁用</a>
				                                <a title="删除" class="btn btn-danger ajax-post confirm" target-form="ids"
				                                    href="<?php echo url('admin/auth_rule/delete'); ?>"><i
				                            ...
				                            <tbody>
				                                ...
				                                <tr>
													<td class="align-middle"><input type="checkbox" class="i-checks ids"
														name="ids[]" value="<?php echo htmlentities($vo['id']); ?>"></td>
													<td class="align-middle"><?php echo htmlentities($vo['id']); ?></td>
				                                    <td class="align-middle"><input type="text" name="sort[]" value="<?php echo htmlentities($vo['sort']); ?>"
				                                            class="form-control text-center inline sort"
				                                            style="width: 50px; height: 25px;"><input type="hidden"
				                                            class="i-checks idsort" name="idsort[]" value="<?php echo htmlentities($vo['id']); ?>"></td>
				                                    <td class="align-middle"><i class="<?php echo htmlentities($vo['icon']); ?>"></i> <span><?php echo $vo['title_display']; ?></td>
				                                    <td class="align-middle"><?php echo htmlentities($vo['name']); ?></td>
				                                    <td class="align-middle"><?php echo htmlentities($vo['remark']); ?></td>
													<td class="align-middle">
														<?php switch($vo['type']): case "1": ?><span class="badge badge-pill badge-primary">模块</span><?php break; case "2": ?><span class="badge badge-pill badge-success">控制器</span><?php break; case "3": ?><span class="badge badge-pill badge-warning">方法</span><?php break; default: ?>无
														<?php endswitch; ?>
													</td>
													<?php if($vo['status']==1): ?>
