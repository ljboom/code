<?php /*a:7:{s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/fund/index.html";i:1621061720;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
									...
									<div class="search-bar row">
										...
										<div class="input-group col-sm-5">
											...
											<div class="input-group-prepend">
												...
												<?php switch(input('get.fund_type')): case "BLEND": ?>混合型<?php break; case "BOND": ?>债券型<?php break; case "INDEX": ?>指数型<?php break; case "STOCK": ?>股票型<?php break; case "CURRENCY": ?>货币型<?php break; default: ?>全部产品类型
												<?php endswitch; ?>
												</button>
												<input type="hidden" name="fund_type" value="<?php echo input('get.fund_type'); ?>" />
												<ul class="dropdown-menu" x-placement="bottom-start"
													style="position: absolute; top: 35px; left: 0px; will-change: top, left;">
												    <li>
														<a class="search-dropdown" data-value="all"
															href="javascript:void(0)" data-name="fund_type">全部产品类型</a>
													</li>
													<li>
														<a class="search-dropdown" data-value="BLEND"
															href="javascript:void(0)" data-name="fund_type">混合型</a>
													</li>
													<li>
														<a class="search-dropdown" data-value="BOND"
															href="javascript:void(0)" data-name="fund_type">债券型</a>
													</li>
													<li>
														<a class="search-dropdown" data-value="INDEX"
															href="javascript:void(0)" data-name="fund_type">指数型</a>
													</li>
													<li>
														<a class="search-dropdown" data-value="STOCK"
															href="javascript:void(0)" data-name="fund_type">股票型</a>
													</li>
													<li>
														<a class="search-dropdown" data-value="CURRENCY"
															href="javascript:void(0)" data-name="fund_type ">货币型</a>
													</li>
												</ul>
											</div>
											...
											<div class="input-group-prepend">
												<button data-toggle="dropdown" class="btn btn-white dropdown-toggle" type="button" aria-expanded="false">
													<?php switch(input('get.type')): case "id": ?>ID<?php break; case "fund_code": ?>基金代码<?php break; case "fund_name": ?>基金名称<?php break; default: ?>不限
													<?php endswitch; ?>
												</button>
												...
												<ul class="dropdown-menu" x-placement="bottom-start"
													style="position: absolute; top: 35px; left: 0px; will-change: top, left;">
													<li>
														<a class="search-dropdown" data-name="type" data-value="all"
															href="javascript:void(0)">不限</a>
													</li>
													<li>
														<a class="search-dropdown" data-name="type" data-value="id"
															href="javascript:void(0)">ID</a>
													</li>
													<li>
														<a class="search-dropdown" data-name="type" data-value="fund_code"
															href="javascript:void(0)">基金代码</a>
													</li>
													<li>
														<a class="search-dropdown" data-name="type" data-value="fund_name"
															href="javascript:void(0)">基金名称</a>
													</li>
													<!--<li>-->
						...
						<div class="row m-b">
							<div class="col-sm-12">
								<div class="toolbar-btn-action">
									...
									<a title="添加" class="btn btn-success" href="<?php echo url('admin/fund/add'); ?>"><i
									...
									<a title="删除" class="btn btn-danger ajax-post confirm" target-form="ids"
										href="<?php echo url('admin/fund/deletes'); ?>"><i
							...
							<table class="table table-bordered table-hover">
							 ...
							 <?php foreach($list as $v): ?>
							        <tr>
							            ...
							            <td class="align-middle"><?php echo htmlentities($v['fund_code']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['fund_name']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['fund_type_text']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['net_value']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['net_value_date']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['day_of_growth']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['last_week']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['last_month']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['last_quarter']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['last_half_year']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['last_year']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['service_rate']); ?></td>
							            <td class="align-middle"><?php echo htmlentities($v['trustee_rate']); ?>%</td>
							            <td class="align-middle"><?php echo htmlentities($v['manage_rate']); ?>%</td>
							            <td class="align-middle"><?php echo htmlentities($v['type_text']); ?></td>
							            <td class="align-middle">
							                	<a href="<?php echo url('admin/fund/edit?id='.$v['id']); ?>" class="btn btn-primary btn-xs"
												_tag="edit" data-toggle="tooltip" data-placement="top" title="修改"><i
													class="fa fa-pencil"></i></a>
													
												<!--<a href="<?php echo url('admin/users/editStatus?id='.$v['id'].'&type=2'); ?>"-->
												...
												<!--<a href="<?php echo url('admin/users/editStatus?id='.$v['id'].'&type=1'); ?>" class="btn btn-success btn-xs ajax-get confirm"-->
