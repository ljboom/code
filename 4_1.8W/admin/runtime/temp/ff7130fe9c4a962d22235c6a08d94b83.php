<?php /*a:7:{s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/users/useredit.html";i:1619164668;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="col-lg-12">
			<div class="ibox ">
				...
				<div class="ibox-content">
					<form action="<?php echo url('admin/users/useredit'); ?>" name="form-builder"
						method="post" id="form">
						<div class="form-group row"><label class="col-sm-2 col-form-label"><span
									class="text-danger">*</span>用户名</label>
							<div class="col-md-10"><input type="text" name="mobile" placeholder="请输入用户名"
									class="form-control" value="<?php echo htmlentities($userData['mobile']); ?>"><span
									class="form-text m-b-none">登录账号不能重复，账号创建后不能再次修改</span></div>
						</div>
						<!--<div class="hr-line-dashed"></div>-->
						<!--<div class="form-group row"><label class="col-sm-2 col-form-label"><span-->
						<!--			class="text-danger">*</span>昵称</label>-->
						<!--	<div class="col-md-10"><input type="text" name="username" class="form-control"-->
						<!--			placeholder="请输入昵称" value="<?php echo htmlentities($userData['username']); ?>"><span class="form-text m-b-none">用户展示的账号名称，请尽量保持不要重复</span>-->
						<!--	</div>-->
						<!--</div>-->
						...
						<div class="form-group row"><label class="col-sm-2 col-form-label"><span
							...
							<div class="col-md-10"><input type="password" name="password" class="form-control"
									placeholder="请输入密码"><span class="form-text m-b-none">（不修改可以不填）</span></div>
						</div>
						
							<div class="hr-line-dashed"></div>
						<div class="form-group row"><label class="col-sm-2 col-form-label"><span
									class="text-danger">*</span>支付密码</label>
							<div class="col-md-10"><input type="password" name="pay_password" class="form-control"
									placeholder="请输入密码"><span class="form-text m-b-none">（不修改可以不填）</span></div>
						</div>
					    
						<div class="hr-line-dashed"></div>
						<div class="form-group row"><label class="col-sm-2 col-form-label">余额</label>
							<div class="col-md-10"><input type="text" name="money" class="form-control"
									placeholder="请输入余额" value="<?php echo htmlentities($userData['money']); ?>"></div>
						</div>
						<div class="hr-line-dashed"></div>
						...
						<div class="hr-line-dashed"></div>
						<input type="hidden" name="id" value="<?php echo htmlentities($userData['id']); ?>">
