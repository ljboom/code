<?php /*a:7:{s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/user/index.html";i:1619145540;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
								...
								<form method="get" action="" id="form">
									<div class="search-bar row">
										...
										<div class="input-group col-sm-5">
											...
											<div class="input-group-prepend">
												<button data-toggle="dropdown" class="btn btn-white dropdown-toggle" type="button" aria-expanded="false">
													<?php if(is_array($role_list) || $role_list instanceof \think\Collection || $role_list instanceof \think\Paginator): $k = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;if(input('get.group_id')==$key): ?><?php echo htmlentities($vo); ?><?php endif; ?>
													<?php endforeach; endif; else: echo "" ;endif; if(!input('get.group_id')): ?>全部组员<?php endif; ?>
												</button>
												<input type="hidden" name="group_id" value="<?php echo input('get.group_id'); ?>" />
												<ul class="dropdown-menu" x-placement="bottom-start" style="position: absolute; top: 35px; left: 0px; will-change: top, left;">
													...
													<?php if(is_array($role_list) || $role_list instanceof \think\Collection || $role_list instanceof \think\Paginator): $k = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
													<li>
														<a class="search-dropdown" data-value="<?php echo htmlentities($key); ?>" href="javascript:void(0)" data-name="group_id"><?php echo htmlentities($vo); ?></a>
													</li>
													<?php endforeach; endif; else: echo "" ;endif; ?>
												</ul>
											</div>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										<td class="align-middle"><?php if($data['uid']!=1): ?><input type="checkbox" class="i-checks ids" name="ids[]" value="<?php echo htmlentities($data['uid']); ?>"><?php endif; ?></td>
										<td class="align-middle"><?php echo htmlentities($data['uid']); ?></td>
										<td class="align-middle">
											<a href="<?php echo htmlentities((isset($data['avatar']) && ($data['avatar'] !== '')?$data['avatar']:'/static/admin/img/avatar.png')); ?>" title="<?php echo htmlentities($data['nickname']); ?>" data-gallery=""><img
													src="<?php echo htmlentities((isset($data['avatar']) && ($data['avatar'] !== '')?$data['avatar']:'/static/admin/img/avatar.png')); ?>" alt="<?php echo htmlentities($data['nickname']); ?>"
													style="max-height:40px;max-width:40px"></a>
										</td>
										<td class="align-middle"><?php echo htmlentities($data['username']); ?></td>
										<td class="align-middle"><?php echo htmlentities($data['nickname']); ?></td>
										<td class="align-middle"><?php echo htmlentities($role_list[$data['group_id']]); ?></td>
										<td class="align-middle"><?php echo htmlentities($data['email']); ?></td>
										<td class="align-middle">
											账号创建于 <span class="text-info"><?php echo htmlentities(date('Y年m月d日 H:i:s',!is_numeric($data['create_time'])? strtotime($data['create_time']) : $data['create_time'])); ?></span>，共登录了 <span
												class="text-info"><?php echo htmlentities($data['login_num']); ?></span> 次<br>
											<?php if($data['login_num']>0): ?>
											最近于 <span class="text-info"><?php echo htmlentities(date('Y年m月d日 H:i:s',!is_numeric($data['last_login_time'])? strtotime($data['last_login_time']) : $data['last_login_time'])); ?></span> 通过 <span
												class="text-info"><?php echo htmlentities($data['last_login_ip']); ?></span> 登录，
										...
										<td class="align-middle tooltip-demo">
											<?php if($data['uid']!=1): ?>
											<a href="<?php echo url('admin/user/edit?id='.$data['uid']); ?>" class="btn btn-primary btn-xs"
												_tag="edit" data-toggle="tooltip" data-placement="top" title="修改"><i
													class="fa fa-pencil"></i></a>
												<?php if($data['status']==1): ?>
												<a href="<?php echo url('admin/user/editStatus?id='.$data['uid'].'&type=2'); ?>"
												...
												<?php else: ?>
												<a href="<?php echo url('admin/user/editStatus?id='.$data['uid'].'&type=1'); ?>" class="btn btn-success btn-xs ajax-get confirm"
													_tag="enable" data-toggle="tooltip" data-placement="top" title="启用"><i class="fa fa-check"></i></a>
												<?php endif; ?>
											<a href="<?php echo url('admin/user/delete?id='.$data['uid']); ?>"
