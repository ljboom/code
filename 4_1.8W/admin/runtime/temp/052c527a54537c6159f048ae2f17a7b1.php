<?php /*a:7:{s:64:"/www/wwwroot/test.dkewl.com/application/admin/view/users/index.html";i:1620725828;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
							    ...
							    <?php foreach($list as $v): ?>
							        <tr>
							            <td class="align-middle"><?php if($v['id']!=1): ?><input type="checkbox" class="i-checks ids" name="ids[]" value="<?php echo htmlentities($v['id']); ?>"><?php endif; ?></td>
							            	...
							            	<!--<td class="align-middle"><?php echo htmlentities($v['username']); ?></td>-->
							            	...
							            	<td class="align-middle"><?php if(($v['logintime'] < 1000)): ?>暂未登录<?php else: ?><?php echo date('Y-m-d H:i:s',$v['logintime']);?><?php endif; ?></td>
							            	...
							            	<td class="align-middle">
							            	    	...
							            	    	<a href="<?php echo url('admin/users/useredit?id='.$v['id']); ?>" class="btn btn-primary btn-xs"
												...
												<?php endif; ?>
													...
													<a href="<?php echo url('admin/users/deletes?id='.$v['id']); ?>"
												class="btn btn-danger btn-xs ajax-get confirm" _tag="delete"
												data-toggle="tooltip" data-placement="top" title="删除"><i
													class="fa fa-trash"></i></a>
													
												<a href="<?php echo url('admin/users/userData?id='.$v['id']); ?>" class="btn btn-primary btn-xs"
