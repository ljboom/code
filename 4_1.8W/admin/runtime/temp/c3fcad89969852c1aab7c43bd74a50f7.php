<?php /*a:7:{s:71:"/www/wwwroot/test.dkewl.com/application/admin/view/help/feedback_list.html";i:1632418067;s:59:"/www/wwwroot/test.dkewl.com/application/admin/view/layout.html";i:1618975294;s:63:"/www/wwwroot/test.dkewl.com/application/admin/view/common/nav.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/header.html";i:1618724626;s:66:"/www/wwwroot/test.dkewl.com/application/admin/view/common/footer.html";i:1618724626;s:67:"/www/wwwroot/test.dkewl.com/application/admin/view/common/sidebar.html";i:1618724626;s:72:"/www/wwwroot/test.dkewl.com/application/admin/view/common/theme-config.html";i:1618724626;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="ibox-content m-b-sm border-bottom">
					<div class="p-xs">
						<div class="float-left m-r-md">
							<i class="fa fa-wrench text-navy mid-icon"></i>
						</div>
						<h2>意见反馈列表</h2>
							...
							<div class="col-sm-12">
								<div class="toolbar-btn-action">
									...
									<a title="审核通过" class="btn btn-success ajax-post confirm" target-form="ids"
										href="<?php echo url('admin/help/feedback_editStatus?type=2'); ?>"><i
											class="fa fa-check-circle-o"></i> 审核通过</a>
									<a title="审核驳回" class="btn btn-warning ajax-post confirm" target-form="ids"
										href="<?php echo url('admin/help/feedback_editStatus?type=3'); ?>"><i
							...
							<table class="table table-bordered table-hover">
							 ...
							 <?php foreach($list as $v): ?>
							        <tr>
							            ...
							            <td class="align-middle"><img src="http://10.168.1.111<?php echo htmlentities($v['voucher']); ?>" height="100"></td>
							           ...
							           <td class="align-middle">
							            ...
							            <td class="align-middle">
							               		...
							               		<?php if($v['status']==1): ?>
												<a href="<?php echo url('admin/help/feedback_editStatus?id='.$v['id'].'&type=3'); ?>"
													...
													data-toggle="tooltip" data-placement="top" title="审核通过"><i class="fa fa-close">驳回审核</i></a>
														...
														<a href="<?php echo url('admin/help/feedback_editStatus?id='.$v['id'].'&type=2'); ?>" class="btn btn-success btn-xs ajax-get confirm"
