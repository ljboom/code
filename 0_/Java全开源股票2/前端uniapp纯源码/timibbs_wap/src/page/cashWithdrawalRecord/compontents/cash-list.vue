          ...
          <div class="order-info-box" style="border-radius: .15rem">
            <div class="order-title">
              ...
              <span class="red pull-right">
                        {{item.withStatus == 1?$t("hj337"):item.withStatus == 2?$t("hj338"):item.withStatus == 3?$t("hj339"):$t("hj340")}}
            ...
            <div class="order-info">
              ...
              <p class="clearfix">
                <span class="col-xs-12">{{ $t("hj213") }}:<b class="space">{{item.bankName}}-{{item.bankAddress}}</b></span>
              </p>
              <p class="clearfix">
                <span class="col-xs-12">{{ $t("hj215") }}:<b class="space">{{item.bankNo}}</b></span>
              </p>
              <p v-if="item.withStatus == 3" class="clearfix">
                <span class="col-xs-12">{{ $t("hj341") }}:<b class="space">{{item.withMsg}}</b></span>
              </p>
              <p v-if="item.withStatus == 2" class="clearfix">
                <span class="col-xs-12">{{ $t("hj342") }}:<b class="space">{{item.withMsg}}</b></span>
              </p>
              <p class="clearfix">
