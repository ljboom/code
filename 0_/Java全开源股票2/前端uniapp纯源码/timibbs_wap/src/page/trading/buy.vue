    ...
    <div class="content">
        ...
        <div class="tabs_content">
          ...
          <div class="tr_rs">
            <div class="top_bzz" style="padding-bottom: 0.2rem;">
              <span style="text-align: left;">{{ $t('hj102') }}({{ currency }})</span>
              <span style="text-align: right;">{{ $t('hj103') }}({{ currency }})</span>
            </div>
            <div class="bottom_bzz">
              ...
              <span v-if="$store.state.userInfo != undefined && type == '0'" style="white-space: nowarp;">
      ...
      <div class="switchs">
        ...
        <div class="zy" v-show="checkedZs">
          <div class="left_zy">
            <input v-model="zhisun" onkeyup="value=value.replace(/^\D*(\d*(?:\.\d{0,2})?).*$/g, '$1')" />
          </div>
          <div class="right_sw" style="width:auto;">
