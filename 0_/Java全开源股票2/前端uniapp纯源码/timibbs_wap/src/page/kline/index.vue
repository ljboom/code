  ...
  <div class="kline_detail_page">
    <div class="content">
            ...
            <div class="content_money">
              <div class="top_price">
                ...
                <div class="right">
                  ...
                  <span v-if="$store.state.userInfo != undefined && kLineDetails.if_zhishu == '0'"
                    style="white-space: nowarp;">
                    {{ currency }} {{ userEnableAmt | formatDecimal }}
                  </span>
                </div>
                <div class="sanjiao">
                  <!-- <img
      ...
      <div class="priect_top_bottom"
        v-if="(kLineDetails.if_us != 1 && kLineDetails.type != 'hk' && kLineDetails.type != 'my' && kLineDetails.type != 'th' && kLineDetails.type != 'in') && kLineDetails.type != 'my' && kLineDetails.type != 'th'&& kLineDetails.type != 'in' && kLineDetails.type != 'hk'  && kLineDetails.if_zhishu == 0">
        <div class="t_title">
          <span>{{ $t('hj76') }}</span>
        </div>
        <div class="charts">
        ...
        <div class="charts">
          <div class="left_s">
            ...
            <div class="ets" v-for="item in timedata.data.details">
              <div class="left_sell1">
                <span style="color: black">{{ item.split(',')[0] }}</span>
              </div>
              <div class="right_sell1">
                <span>{{ }}</span>
              </div>
          ...
          <div class="right_h">
            ...
            <div class="ets" v-for="item in timedata.data.details">
              <div class="left_sell1">
                <span style="color: black">{{ parseFloat(item.split(',')[1]).toFixed2(3) }}</span>
              </div>
              <div class="right_sell1">
                <span>{{ }}</span>
              </div>
          ...
          <div class="right_h" style="display: none;">
            <div class="t_ma">
              <span>{{ $t('hj82') }}</span>
            </div>
            <div class="ets" v-for="item in timedata.data.details">
...
export default {
  ...
  methods: {
    initAccountMoney(){
      ...
      var ifUs = this.kLineDetails.if_us;
      console.log(userInfo);
      if(ifUs === "1"){
        this.currency = "$";
        this.userEnableAmt = userInfo.usEnableAmt;
      } else if(ifUs === "2"){
        this.currency = "HKD";
        this.userEnableAmt = userInfo.hkEnableAmt;
      } else if(ifUs === "3"){
        this.currency = "MYR";
        this.userEnableAmt = userInfo.myEnableAmt;
      } else if(ifUs === "4"){
        this.currency = "THB";
        this.userEnableAmt = userInfo.thEnableAmt;
      } else if(ifUs === "5"){
        this.currency = "INR";
        this.userEnableAmt = userInfo.inEnableAmt;
      }
    },
    async getHknews() {
