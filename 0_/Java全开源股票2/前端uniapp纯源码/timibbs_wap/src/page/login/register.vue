      ...
      <div class="login_forms">
        <div class="top_forms">
          ...
          <div class="user_name">
            ...
            <el-input id="areaCode" style="width:20%;margin-right:15px" size="medium" v-model="areaCode" maxlength="11">
            </el-input>

          <el-input style="width:75%" :placeholder="placeholder" size="medium" v-model="phone" clearable @input="handleInput()" maxlength="11">
          </el-input>
...
export default {
  ...
  methods: {
    ...
    async getcode() {
      ...
      let reg = /^[0-9A-Za-z@+*._\s]{4,20}$/ // 手机号码验证
