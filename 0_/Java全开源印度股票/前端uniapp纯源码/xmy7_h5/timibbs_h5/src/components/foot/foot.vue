  ...
  >
    <mt-tabbar v-model="select">
      <mt-tab-item id="home" :class="$store.state.select == '/home' ? 'on' : ''">
        ...
        >
        <p v-if="$store.state.select == '/home'" :style="{color: $state.theme === 'black' ? '#138DB3' : '#C11815'}">{{ $t("hj224") }}</p>
        <p v-else :style="{color: $state.theme === 'black' ? '#FFFFFF' : '#656565'}">{{ $t("hj224") }}</p>
      ...
      <mt-tab-item id="list" :class="$store.state.select == '/list' || $store.state.select == '/indexlist'? 'on' : ''">
        ...
        >
        <p v-if="$store.state.select == '/list'" :style="{color: $state.theme === 'black' ? '#138DB3' : '#C11815'}">{{ $t("hj242") }}</p>
        <p v-else :style="{color: $state.theme === 'black' ? '#FFFFFF' : '#656565'}">{{ $t("hj242") }}</p>
      ...
      <mt-tab-item id="orderlist" :class="$store.state.select == '/orderlist' ? 'on' : ''">
        ...
        >
        <p v-if="$store.state.select == '/orderlist'" :style="{color: $state.theme === 'black' ? '#138DB3' : '#C11815'}">{{ $t("hj2") }}</p>
        <p v-else :style="{color: $state.theme === 'black' ? '#FFFFFF' : '#656565'}">{{ $t("hj2") }}</p>
      </mt-tab-item>
      <mt-tab-item id="mylist" :class="$store.state.select == '/mylist' ? 'on' : ''">
        ...
        >
        <p v-if="$store.state.select == '/mylist'" :style="{color: $state.theme === 'black' ? '#138DB3' : '#C11815'}">{{$t("hj61")}}</p>
        <p v-else :style="{color: $state.theme === 'black' ? '#FFFFFF' : '#656565'}">{{$t("hj61")}}</p>
      ...
      <mt-tab-item id="user" :class="$store.state.select == '/user' ? 'on' : ''">
        ...
        >
        <p v-if="$store.state.select == '/user'" :style="{color: $state.theme === 'black' ? '#138DB3' : '#C11815'}">{{$t("hj227")}}</p>
        <p v-else :style="{color: $state.theme === 'black' ? '#FFFFFF' : '#656565'}">{{$t("hj227")}}</p>
