<template>
  <div class="login_dialog_pag">
    <van-popup v-model="$store.state.dialogVisible" position="bottom" :close-on-click-overlay="clickOverlay" @click-overlay="overlay" :style="{ height: '60%' }">
  ...
  .dialog_content {
    ...
    .names {
      ...
      span {
        ...
        //background: linear-gradient(85deg, #FFA500 0%, 	#FF8C00 100%);
