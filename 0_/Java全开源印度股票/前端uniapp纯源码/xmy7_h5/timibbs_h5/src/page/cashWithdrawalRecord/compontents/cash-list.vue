          ...
          <div class="order-info-box" style="border-radius: .15rem">
            <div class="order-title">
              ...
              <span class="red pull-right">
                        {{item.withStatus == 1?$t('hj326'):item.withStatus == 2?$t('hj327'):item.withStatus == 3?$t('hj330'):$t('hj202')}}
            ...
            <div class="order-info">
              <p class="clearfix">
                ...
                <span class="col-xs-6">{{$t('hj329')}}:<b class="space" style="font-size:0.26rem">{{item.withAmt - item.withFee}}</b></span>
              </p>
              <p class="clearfix">
                <span class="col-xs-12">{{$t('MingCheng')}}:<b class="space">{{item.bankName}}-{{item.bankAddress}}</b></span>
              </p>
              <p class="clearfix">
                <span class="col-xs-12">{{$t('hj325')}}:<b class="space">{{item.bankNo}}</b></span>
              </p>
              <p v-if="item.withStatus == 3" class="clearfix">
                <span class="col-xs-12">{{$t('hj324')}}:<b class="space">{{item.withMsg}}</b></span>
              </p>
              <p v-if="item.withStatus == 2" class="clearfix">
                <span class="col-xs-12">{{$t('hj201')}}:<b class="space">{{item.withMsg}}</b></span>
              </p>
              <p class="clearfix">
                        <span class="secondary col-xs-6">{{$t('hj80')}}:
