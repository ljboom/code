<template>
  <div class="tr_list_page">
    ...
    <div class="top_titlenew" ref="topTitle">
      ...
      <div class="cards" v-if="tabsIndex === 1 && dialogFlag==true">
        <div class="card_item">
      ...
      <div class="walletinfo" v-if="tabsIndex === 1">
          <div class="qian">
            <div class="qianleft">
      ...
      <!-- 搜索框 -->
      <div class="search" v-if="tabsIndex === 0">
        <div class="search_content">
          <div class="left_search">
            <div class="search_img">
              <img src="../../assets/img/searchs.png" alt />
    ...
    <div class="content">
      <div class="tabs">
        <div class="bottom_contentmarket" v-if="tabsIndex === 1">
      ...
      <div class="setting_content">
        <div class="old_password">
          ...
          <div class="right_password_input">
            <input type="number" v-model="sgNum" disabled />
          </div>
        </div>
