<template>
    <div>
        <div class="heabox">
            <div class="toubu">
                ...
                <van-tabs v-model="tabactive" class="ghbn" @click="getNewsList()" color="#ffffff"
                    ...
                    background="#197af6">
                    <van-tab title="大宗交易" name="1"></van-tab>
                    <van-tab title="VIP抢筹" name="2"></van-tab>
                </van-tabs>
            </div>
        ...
        <div>    
            <div class="xuanhze">
                <dazongjiaoyi v-if="tabactive == 1"></dazongjiaoyi>       
                <vipqiangchou v-if="tabactive == 2"></vipqiangchou>    
            </div>
        </div>
    </div>
</template>
