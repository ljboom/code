    ...
    <div>
        ...
        <div class="goumais">
            <div class="xiaoge"><span><img
                ...
                <div class="rtyh">
                    <div class="kunk"><input :placeholder="$t('hj262')" v-model="buyNum"
                            @input="buyNum = buyNum.replace(/^(0+)|[^\d]+/g, '')" type="number"><a class="shou">{{$t('hj117')}}</a>
                    </div>
                </div>
            </div>
            <p class="shougu">1{{$t('hj117')}}=100{{$t('hj274')}}</p>
            <div class="xiaoge">
            ...
            <div class="rtyh">
                <div class="fangxi">
                    <a class="fanh" :class="buyType == 0 ? 'xuk' : ''" @click="buyType = 0">{{$t('hj85')}}</a>
                    <a class="fanh" :class="buyType == 1 ? 'xuk' : ''" @click="buyType = 1">{{$t('hj84')}}</a>
                </div>
            </div>
            <div class="xiaoge">
                ...
                <div class="rtyh" @click="showPicker = true">
                    <div class="kunk">
                        <input :placeholder="$t('hj275')" disabled="disabled" v-model="lever" class="canwei">
            ...
            <div class="xiaoge">
                ...
                <div class="eduright"><a class="ertyu"> ￥{{ (currentItem.p * buyNum / lever / 10).toFixed(2) }}</a>
                </div>
            </div>
            <!-- <div class="xiaoge">
                <span class="eduleft"><img
        ...
        <div class="mail" @click="getbuyVipQc()">{{buyType == 0 ? $t('hj85') : $t('hj84')}}</div>
    ...
    methods: {
        ...
        async getbuyVipQc() {
            if (this.buyNum * 100 < this.settingdetail.buyMinNum) {
                this.$message.error(this.$t('hj277') + this.settingdetail.buyMinNum / 100 + '手');
                return
            }
            if (this.buyNum * 100 > this.settingdetail.buyMaxNum) {
                this.$message.error(this.$t('hj278') + this.settingdetail.buyMaxNum / 100 + '手');
                return
            }
            var opt = {
