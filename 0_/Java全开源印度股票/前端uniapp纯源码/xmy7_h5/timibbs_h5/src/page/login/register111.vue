    ...
    <div class="logins_content">
      ...
      <div class="login_forms">
        <div class="top_forms">
          ...
          <el-input :placeholder="$t('hj16')" size="medium" v-model="phone" clearable @input="handleInput()" maxlength="30">
          </el-input>
          ...
          <div class="bottom_btns" :hidden="true">
          <el-input style="margin-top: 0.46rem;width: 5rem;" :placeholder="verification" size="medium" v-model="code" clearable>
          </el-input>
          <button  style="background-color: rgb(61, 223, 36);width: 3rem;height: 1rem;border-radius: 0.3rem;" @click="checkCodeBox()">{{ $t('hj25') }}</button>
        </div>
        </div>
