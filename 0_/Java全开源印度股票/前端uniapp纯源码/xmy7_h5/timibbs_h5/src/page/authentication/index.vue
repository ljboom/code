  ...
  <div class="bank_card_page">
      ...
      <div class="uploads">
        <div class="lefts">
          <el-upload :with-credentials="true"
            ...
            :src="form.img1key"
            class="id-img avatar" style="width: 100%;height: 100%;" />
    ...
    <div class="pass">
      <div class="top_t">
        ...
        <span v-if="!showBtn && this.$store.state.userInfo.isActive != 1"><img src="@/assets/img/dui.svg">{{ $t('hj203') }}</span>
...
export default {
  ...
  mounted() {
    ...
    if (this.admin == undefined) {
      this.admin = "https://api.bpeasia.net/dtapi";
    }
  },
  methods: {
    ...
    // 获取用户信息
    let data = await api.getUserInfo(opt);
    if (data.status === 0) {
      // 判断是否登录
