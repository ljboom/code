	...
	<div class="pageheader notab">
		<ul class="txt">
			<li>
				<div>
					<h1>今日充值</h1>
					<p><span class="num"><?php echo ((isset($tAmoney) && ($tAmoney !== ""))?($tAmoney):"0"); ?>元</span></p>
					<p><span class="num"><?php echo ((isset($tymoney) && ($tymoney !== ""))?($tymoney):"0"); ?>元</span>已支付&nbsp;&nbsp;<span class="num"><?php echo ((isset($twmoney) && ($twmoney !== ""))?($twmoney):"0"); ?>元</span>未支付</p>
				</div>
			</li>
			<li>
				<div>
					<h1>昨日充值</h1>
					<p><span class="num"><?php echo ((isset($zAmoney) && ($zAmoney !== ""))?($zAmoney):"0"); ?>元</span></p>
					<p><span class="num"><?php echo ((isset($zymoney) && ($zymoney !== ""))?($zymoney):"0"); ?>元</span>已支付&nbsp;&nbsp;<span class="num"><?php echo ((isset($zwmoney) && ($zwmoney !== ""))?($zwmoney):"0"); ?>元</span>未支付</p>
				</div>
			</li>
			<li>
				<div>
					<h1>本月充值</h1>
					<p><span class="num"><?php echo ((isset($yAmoney) && ($yAmoney !== ""))?($yAmoney):"0"); ?>元</span></p>
					<p><span class="num"><?php echo ((isset($yymoney) && ($yymoney !== ""))?($yymoney):"0"); ?>元</span>已支付&nbsp;&nbsp;<span class="num"><?php echo ((isset($ywmoney) && ($ywmoney !== ""))?($ywmoney):"0"); ?>元</span>未支付</p>
				</div>
			</li>
			<li>
				<div>
					<h1>累计充值</h1>
					<p><span class="num"><?php echo ((isset($lAmoney) && ($lAmoney !== ""))?($lAmoney):"0"); ?>元</span></p>
					<p><span class="num"><?php echo ((isset($lymoney) && ($lymoney !== ""))?($lymoney):"0"); ?>元</span>已支付&nbsp;&nbsp;<span class="num"><?php echo ((isset($lwmoney) && ($lwmoney !== ""))?($lwmoney):"0"); ?>元</span>未支付</p>
				</div>
			</li>
		</ul>
    </div>
		...
		<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><?php echo ($vo['dmoney']); ?></td>
					<td><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?></td>
					<td><?php if($vo['pay_time']): echo (date("Y-m-d H:i:s",$vo["pay_time"])); else: ?>-<?php endif; ?></td>
					<td><?php if($vo['status'] == 2): ?>已支付<?php else: ?>未支付<?php endif; ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
			</tbody>
		</table>
