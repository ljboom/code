		...
		<ul class="txt">
			<li>
				<div>
					...
					<p><span class="num"><?php echo ((isset($tymoney) && ($tymoney !== ""))?($tymoney):"0"); ?>元</span>已分成&nbsp;&nbsp;<span class="num"><?php echo ((isset($twmoney) && ($twmoney !== ""))?($twmoney):"0"); ?>元</span>未分成</p>
				</div>
			</li>
			<li>
				<div>
					...
					<p><span class="num"><?php echo ((isset($zymoney) && ($zymoney !== ""))?($zymoney):"0"); ?>元</span>已分成&nbsp;&nbsp;<span class="num"><?php echo ((isset($zwmoney) && ($zwmoney !== ""))?($zwmoney):"0"); ?>元</span>未分成</p>
				</div>
			</li>
			<li>
				<div>
					...
					<p><span class="num"><?php echo ((isset($yymoney) && ($yymoney !== ""))?($yymoney):"0"); ?>元</span>已分成&nbsp;&nbsp;<span class="num"><?php echo ((isset($ywmoney) && ($ywmoney !== ""))?($ywmoney):"0"); ?>元</span>未分成</p>
				</div>
			</li>
			<li>
				<div>
					...
					<p><span class="num"><?php echo ((isset($lymoney) && ($lymoney !== ""))?($lymoney):"0"); ?>元</span>已分成&nbsp;&nbsp;<span class="num"><?php echo ((isset($lwmoney) && ($lwmoney !== ""))?($lwmoney):"0"); ?>元</span>未分成</p>
				</div>
			</li>
		</ul>
    </div>
