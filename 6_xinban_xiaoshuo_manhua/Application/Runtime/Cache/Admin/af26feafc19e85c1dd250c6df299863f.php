...
<!--            <li>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">小说分集管理（<?php echo ($info["title"]); ?>）</h1>
            <span class="pagedesc">对小说分集进行增加，修改或者删除等操作</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21" style="background:#fff">
			...
			<div class="tableoptions">                    
				<button class="radius3" onclick="location.href='<?php echo U('episodesedit');?>&bid=<?php echo ($bid); ?>'">添加小说分集</button>
			</div><!--tableoptions-->
			...
			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						...
						<th class="head1">点赞数</th>
						<th class="head1">前一话编号</th>
						<th class="head1">下一话编号</th>
						<th class="head1">阅读人数</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td class="center">
							<a href="<?php echo U('episodesedit');?>&bid=<?php echo ($bid); ?>&id=<?php echo ($vo['id']); ?>">修改</a> | 
