				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						...
						<td>
							...
							<input type="checkbox" name="arrcateids[]" id="arrcateids14" value="14"  <?php if(in_array(14, $arrcateids)): ?>checked<?php endif; ?> />科幻&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids15" value="15"  <?php if(in_array(15, $arrcateids)): ?>checked<?php endif; ?> />竞技&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids16" value="16"  <?php if(in_array(16, $arrcateids)): ?>checked<?php endif; ?> />历史&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids17" value="17"  <?php if(in_array(17, $arrcateids)): ?>checked<?php endif; ?> />现实&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids18" value="18"  <?php if(in_array(18, $arrcateids)): ?>checked<?php endif; ?> />言情&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr>
