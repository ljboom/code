        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post" enctype="multipart/form-data">
				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<td>
					<input type="checkbox" name="arrcateids[]" id="arrcateids1" value="1"  <?php if(in_array(1, $arrcateids)): ?>checked<?php endif; ?> />都市&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids2" value="2"  <?php if(in_array(2, $arrcateids)): ?>checked<?php endif; ?> />搞笑&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids3" value="3"  <?php if(in_array(3, $arrcateids)): ?>checked<?php endif; ?> />悬疑&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids4" value="4"  <?php if(in_array(4, $arrcateids)): ?>checked<?php endif; ?> />热血&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids5" value="5"  <?php if(in_array(5, $arrcateids)): ?>checked<?php endif; ?> />校园&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids6" value="6"  <?php if(in_array(6, $arrcateids)): ?>checked<?php endif; ?> />耽美&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids7" value="7"  <?php if(in_array(7, $arrcateids)): ?>checked<?php endif; ?> />灵异&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids8" value="8"  <?php if(in_array(8, $arrcateids)): ?>checked<?php endif; ?> />治愈&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids9" value="9"  <?php if(in_array(9, $arrcateids)): ?>checked<?php endif; ?> />奇幻&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids10" value="10"  <?php if(in_array(10, $arrcateids)): ?>checked<?php endif; ?> />少女&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids11" value="11"  <?php if(in_array(11, $arrcateids)): ?>checked<?php endif; ?> />恐怖&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids12" value="12"  <?php if(in_array(12, $arrcateids)): ?>checked<?php endif; ?> />豪门&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids13" value="13"  <?php if(in_array(13, $arrcateids)): ?>checked<?php endif; ?> />剧情&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids14" value="14"  <?php if(in_array(14, $arrcateids)): ?>checked<?php endif; ?> />青春&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids15" value="15"  <?php if(in_array(15, $arrcateids)): ?>checked<?php endif; ?> />真人&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids16" value="16"  <?php if(in_array(16, $arrcateids)): ?>checked<?php endif; ?> />情感&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids17" value="17"  <?php if(in_array(17, $arrcateids)): ?>checked<?php endif; ?> />神医&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids18" value="18"  <?php if(in_array(18, $arrcateids)): ?>checked<?php endif; ?> />律师&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids19" value="19"  <?php if(in_array(19, $arrcateids)): ?>checked<?php endif; ?> />福利&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids20" value="20"  <?php if(in_array(20, $arrcateids)): ?>checked<?php endif; ?> />异能&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids21" value="21"  <?php if(in_array(21, $arrcateids)): ?>checked<?php endif; ?> />伦理&nbsp;&nbsp;&nbsp;
					<input type="checkbox" name="arrcateids[]" id="arrcateids22" value="22"  <?php if(in_array(22, $arrcateids)): ?>checked<?php endif; ?> />逆袭&nbsp;&nbsp;&nbsp;
					</td>
					</tr>
					<tr>
