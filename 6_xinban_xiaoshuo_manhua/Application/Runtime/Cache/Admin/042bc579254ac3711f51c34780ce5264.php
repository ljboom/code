...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">动漫分集管理（<?php echo ($info["title"]); ?>）</h1>
            <span class="pagedesc">对动漫分集进行增加，修改或者删除等操作</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21" style="background:#fff">
			...
			<div class="tableoptions">                    
				<button class="radius3" onclick="location.href='<?php echo U('episodesedit');?>&yid=<?php echo ($yid); ?>'">添加动漫分集</button>
			</div><!--tableoptions-->
