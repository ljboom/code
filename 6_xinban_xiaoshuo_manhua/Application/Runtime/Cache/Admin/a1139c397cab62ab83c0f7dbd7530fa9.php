...
<!--            <li>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">视频管理</h1>
            <span class="pagedesc">对视频进行增加，修改或者删除等操作</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
			...
			<div class="tableoptions">                    
				<button class="radius3" onclick="location.href='<?php echo U('addVideo');?>'">添加视频</button>
			</div><!--tableoptions-->

			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						<th class="head0" style="width:50px;">视频ID</th>
						<th class="head1">视频标题</th>
						<th class="head0">封面图</th>
						<!-- <th class="head0">分类</th> -->
						<th class="head1">作者</th>
						<th class="head0">排序(越大越前)</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="background:#fff">
						...
						<td><img src="<?php echo ($vo["cover_pic"]); ?>" width="" height="50px" /></td>
						...
						<td class="center">
							...
							<a href="<?php echo U('del', 'id='.$vo['id']);?>" onclick="return confirm('你确实要删除这个视频吗？')">删除</a>
						</td>
