...
<!--            <li>
    ...
    <div class="centercontent">
            ...
            <h1 class="pagetitle">编辑小说分集（<?php echo ($book["title"]); ?>）</h1>
            <span class="pagedesc">请认真编辑小说分集的各项信息</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						<th class="title">小说内容</th>
						<td>
							<textarea name="info" id="info" class="longinput" style="margin: 0px; height: 400px; max-width:640px;"><?php echo ($info["info"]); ?></textarea>
						</td>
					</tr>
				</table>
