...
<div class="bodywrapper">
    ...
    <div class="centercontent">
            ...
            <h1 class="pagetitle">编辑动漫分集（<?php echo ($book["title"]); ?>）</h1>
            <span class="pagedesc">请认真编辑动漫分集的各项信息</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post" enctype="multipart/form-data">
				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						<th class="title">动漫内容</th>
						<td>
							<input type="text" name="info" id="info" value="<?php echo ($info["info"]); ?>" class="smallinput" />
						</td>
					</tr>
				</table>
