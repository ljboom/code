        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				...
				<p>
					...
					<span class="field">
						<iframe src="<?php echo U('upload', 'event=setPic&url='.$info['cover']);?>" scrolling="no" width="100" height="100"></iframe>
						<input type="hidden" name="cover" id="cover" value="<?php echo ($info["cover"]); ?>" class="smallinput" />
						<script>
						function setPic(url){
				...
				<p>
					<label>封面图片显示在正文</label>
					<span class="field">
						<input type="checkbox" name="show_cover" value="1" <?php if($info['show_cover'] == 1): ?>checked<?php endif; ?> />
					</span>
				</p>
				<p>
					<label>摘要</label>
					<span class="field">
						<textarea name="desc" class="longinput"><?php echo ($info["desc"]); ?></textarea>
					</span>
				</p>
				<p>
					<label>正文内容</label>
