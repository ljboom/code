...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">视频修改</h1>
            <span class="pagedesc">修改视频的基本信息</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				...
				<p>
					<label>视频作者</label>
					<span class="field"><input type="text" name="author" id="author" value="<?php echo ($info["author"]); ?>" class="smallinput" /></span>
				</p>
				<p>
					<label>试看时间（秒）</label>
					<span class="field"><input type="text" name="trytime" id="trytime" value="<?php echo ($info["trytime"]); ?>" class="smallinput" /></span>
				</p>
				<p>
					<label>销售价格</label>
					<span class="field"><input type="text" name="price" id="price" value="<?php echo ($info["price"]); ?>" class="smallinput" /></span>
				</p>
				<p>
					<label>购买数量</label>
					<span class="field"><input type="text" name="sold" id="sold" value="<?php echo ($info["sold"]); ?>" class="smallinput" /></span>
				</p>
				<p>
					<label>视频简介</label>
					<span class="field"><input type="text" name="summary" id="ursummaryls" value="<?php echo ($info["summary"]); ?>" class="smallinput" /></span>
				</p>
				<p>
					<label>视频排序</label>
				...
				<p>
					<label>视频封面图</label>
					<span class="field">
						<iframe src="<?php echo U('Admin/upload', 'event=setPic1&url='.$info['cover_pic']);?>" scrolling="no" width="100" height="100"></iframe>
						<input type="hidden" name="cover_pic" id="cover_pic" value="<?php echo ($info['cover_pic']); ?>" class="smallinput" />
						<script>
