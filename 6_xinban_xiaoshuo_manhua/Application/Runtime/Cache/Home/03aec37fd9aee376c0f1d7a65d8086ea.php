...
<html data-dpr="1" style="font-size: 41.6px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="description" content="小说漫画源码系统致力于打造正版小说漫画在线阅读平台搭建、网站开发,连载众多优秀原创国漫等海量精彩内容,小说漫画网站建设,就用易付漫画小说系统源码!">
    <!-- 共用引入资源.开始 -->
    ...
    <div class="shrink open-box condition-box" style="display: block;">
        <div class="row has-label">
            ...
            <div class="container open-type">
                ...
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=1" type="tid" val="1" <?php if($cateid == 1): ?>class="active"<?php endif; ?> id="open-8">都市</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=2" type="tid" val="2" <?php if($cateid == 2): ?>class="active"<?php endif; ?> id="open-12">搞笑</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=3" type="tid" val="3" <?php if($cateid == 3): ?>class="active"<?php endif; ?> id="open-1">悬疑</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=4" type="tid" val="4" <?php if($cateid == 4): ?>class="active"<?php endif; ?> id="open-11">热血</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=5" type="tid" val="5" <?php if($cateid == 5): ?>class="active"<?php endif; ?> id="open-3">校园</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=6" type="tid" val="6" <?php if($cateid == 6): ?>class="active"<?php endif; ?> id="open-2">耽美</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=7" type="tid" val="7" <?php if($cateid == 7): ?>class="active"<?php endif; ?> id="open-13">灵异</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=8" type="tid" val="8" <?php if($cateid == 8): ?>class="active"<?php endif; ?> id="open-4">治愈</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=9" type="tid" val="9" <?php if($cateid == 9): ?>class="active"<?php endif; ?> id="open-5">奇幻</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=10" type="tid" val="10" <?php if($cateid == 10): ?>class="active"<?php endif; ?> id="open-6">少女</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=11" type="tid" val="11" <?php if($cateid == 11): ?>class="active"<?php endif; ?> id="open-7">恐怖</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=12" type="tid" val="12" <?php if($cateid == 12): ?>class="active"<?php endif; ?> id="open-9">豪门</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=13" type="tid" val="13" <?php if($cateid == 13): ?>class="active"<?php endif; ?> id="open-14">剧情</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=14" type="tid" val="14" <?php if($cateid == 14): ?>class="active"<?php endif; ?> id="open-15">青春</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=15" type="tid" val="15" <?php if($cateid == 15): ?>class="active"<?php endif; ?> id="open-16">真人</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=16" type="tid" val="16" <?php if($cateid == 16): ?>class="active"<?php endif; ?> id="open-17">情感</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=17" type="tid" val="17" <?php if($cateid == 17): ?>class="active"<?php endif; ?> id="open-18">神医</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=18" type="tid" val="18" <?php if($cateid == 18): ?>class="active"<?php endif; ?> id="open-19">律师</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=19" type="tid" val="19" <?php if($cateid == 19): ?>class="active"<?php endif; ?> id="open-20">福利</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=20" type="tid" val="20" <?php if($cateid == 20): ?>class="active"<?php endif; ?> id="open-21">异能</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=21" type="tid" val="21" <?php if($cateid == 21): ?>class="active"<?php endif; ?> id="open-22">伦理</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=22" type="tid" val="22" <?php if($cateid == 22): ?>class="active"<?php endif; ?> id="open-23">逆袭</a></div>
            </div>
        </div>
        <div class="row has-label">
...
<div class="books-list mt-10 mb-tabar" id="html_box">
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item"> 
            <a href="<?php echo U('Mh/bookinfo');?>&mhid=<?php echo ($vo["id"]); ?>"> 
                <div class="cover"> <img src="<?php echo ($vo["cover_pic"]); ?>" > </div> 
                <div class="body"> 
