...
<!--		<div class="item">
            <a href="<?php echo U('Video/index');?>" class="active">动漫</a>
        </div>-->
    </nav>
    <div class="action">
...
<?php if($mf): ?><div class="bm-box mt-10">
	...
	<div class="books-row">
		<?php if(is_array($mf)): $i = 0; $__LIST__ = $mf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div onClick="location.href=&#39;<?php echo U('bookinfo');?>&yid=<?php echo ($vo["id"]); ?>&#39;" style="width:100%;padding-bottom: 20px;border-bottom: 1px solid #ddd;position:relative;">
				...
				<div onClick="location.href=&#39;<?php echo U('bookinfo');?>&yid=<?php echo ($vo["id"]); ?>&#39;" style="position: absolute;top: 10px;right: 10px;padding: 8px;border: 1px solid #FF9800;border-radius: 5px;color: #FF9800;">立即观看</div>
			</div><?php endforeach; endif; else: echo "" ;endif; ?>
	</div>
</div>
<?php else: ?>
