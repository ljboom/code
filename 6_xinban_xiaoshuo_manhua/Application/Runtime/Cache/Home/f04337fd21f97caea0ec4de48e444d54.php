    ...
    <div class="shrink open-box condition-box" style="display: block;">
        <div class="row has-label">
            ...
            <div class="container open-type">
                ...
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=13" type="tid" val="13" <?php if($cateid == 13): ?>class="active"<?php endif; ?> id="open-14">武侠</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=14" type="tid" val="14" <?php if($cateid == 14): ?>class="active"<?php endif; ?> id="open-15">科幻</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=15" type="tid" val="15" <?php if($cateid == 15): ?>class="active"<?php endif; ?> id="open-16">竞技</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=16" type="tid" val="16" <?php if($cateid == 16): ?>class="active"<?php endif; ?> id="open-17">历史</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=17" type="tid" val="17" <?php if($cateid == 17): ?>class="active"<?php endif; ?> id="open-18">现实</a></div>
				<div class="item"><a href="<?php echo ($selfurl); ?>&cateid=18" type="tid" val="18" <?php if($cateid == 18): ?>class="active"<?php endif; ?> id="open-19">言情</a></div>
            </div>
        </div>
        <div class="row has-label">
