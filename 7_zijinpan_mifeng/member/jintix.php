...
<div class="panel-heading">申请提现</div>
  ...
  <!--p>晚上12点后提现早上9点打款处理，打款客服也需要休息，敬请谅解！财富家园与您共创财富</p-->
  <p>提现时间：09:00~21:00(周末正常提现)
  <!>提现将收取<?php echo $webInfo['h_withdrawFee'] * 100; ?>%手续费</p>
...
?>
  ...
  <div class="form-group">
    <label for="x1" class="col-sm-2 control-label">您的余额</label>
    <div class="col-sm-10">
      <input disabled="disabled" class="form-control form-long-w1" id="x1" placeholder="您的余额" value="<?php echo $rs['h_point2'];?>">
    </div>
  </div> 
