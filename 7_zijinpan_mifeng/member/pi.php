...
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#t1" aria-controls="home" role="tab" data-toggle="tab">提现信息</a></li>
    <li role="presentation"><a href="#t2" aria-controls="profile" role="tab" data-toggle="tab">修改登录密码</a></li>
...
<form class="form-horizontal">
  ...
  <div class="form-group">
    <label for="x2" class="col-sm-2 control-label">支付宝收款账号:</label>
    <div class="col-sm-10">
      <input class="form-control form-long-w1" id="x2" placeholder="您的支付宝收款账号" value="<?php echo $rs['h_alipayUserName'];?>">
    </div>
  </div> 
    <div class="form-group">
    ...
    <div class="col-sm-10">
     ...
     <!--div class="form-group">
    <label for="x7" class="col-sm-2 control-label">微信号码:</label>
    <div class="col-sm-10">
      <input class="form-control form-long-w1" id="x7" placeholder="微信号码" value="<?php echo $rs['h_addrTel'];?>">
    </div>
  </div>  
  
 <div class="form-group">
    <label for="x7" class="col-sm-2 control-label">微信收款二维码:</label>
    <div class="col-sm-10">
      <input class="form-control form-long-w1" id="x7" placeholder="微信号码" value="<?php echo $rs['h_addrTel'];?>">
    </div>
  </div--> 
