...
<div id="wrapper">
    <div id="container">
        <div id="main">
            ...
            <div class="lotteryTitle2">玩家:<?php echo $rs['h_userName'];?> 金币:<span id="jinb"><?php echo $rs['h_point2'];?></span></div>
            <div id="lottery">
            	<div class="lotBg">
                    ...
                    <div class="lotTxt">
                    	...
                    	<p class="txt2"><span>TCL么么哒3S</span></p>
                    	<p class="txt3"><span>男款毛衫</span></p>
                    	<p class="txt4"><span>20金币</span></p>
                    	<p class="txt5"><span>8金币</span></p>
            ...
            <div class="shuomingb" style="display:none;">
                    	...
                    	<p class="txtb2"><span>恭喜您抽中二等奖 TCL么么哒3S 手机一部,系统已自动填写订单,请到您的商城订单里查看</span></p>
                    	<p class="txtb3"><span>恭喜您抽中三等奖 男款毛衫 一件,系统已自动填写订单,请到您的商城订单里查看</span></p>
                    	<p class="txtb4"><span>恭喜您抽中四等奖 20金币,系统已经转入您的账户中</span></p>
                    	<p class="txtb5"><span>恭喜您抽中五等奖 8金币,系统已经转入您的账户中</span></p>
