...
<td>
<b>' , $val['h_title'] , '</b><br />
每天' , $val['h_point2Day'] , '元<br />
</td>
<td>

结束日期：' , date('Y-m-d',strtotime($val['h_endTime'])) , '<br />

还可生产：' , ($val['h_life'] - $val['h_settleLen']) , '天，共' , ($val['h_point2Day'] * $val['h_num'] * ($val['h_life'] - $val['h_settleLen'])) , '元<br />
</td>
</tr>';
		}
	}
