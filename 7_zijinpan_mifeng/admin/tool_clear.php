...
<input name="member" type="radio" value="2" id="member2" /><label for="member2">不清空会员，重置会员激活币和金币为0</label><br />
...
<input name="dbs[]" type="checkbox" value="h_point2_sell" id="h_point2_sell" /><label for="h_point2_sell">清空会员拍卖金币数据</label><br />
...
<input name="dbs[]" type="checkbox" value="h_log_point2" id="h_log_point2" /><label for="h_log_point2">清空会员金币明细记录</label><br />
    </td>
  </tr>
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
