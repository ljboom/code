...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="tableborder">
  ...
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    <td align="center">每天生产金币</td>
    <td><input name="h_point2Day" type="text" class="inputclass1" maxlength="25" value="<?php echo $rs['h_point2Day']; ?>" /> 金币
    <font color="#ff0000">*</font></td>
  </tr>
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
  ...
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    ...
    <td><input name="h_money" type="text" class="inputclass1" maxlength="25" value="<?php echo $rs['h_money']; ?>" /> 金币
    <font color="#ff0000">*</font></td>
  </tr>
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="tableborder">
  ...
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    <td align="center">每天生产金币</td>
    <td><input name="h_point2Day" type="text" class="inputclass1" maxlength="25" value="" /> 金币
    <font color="#ff0000">*</font></td>
  </tr>
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    <td align="center">生命周期</td>
  ...
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    <td align="center">售价</td>
    <td><input name="h_money" type="text" class="inputclass1" maxlength="25" value="" /> 金币
    <font color="#ff0000">*</font></td>
  </tr>
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    <td align="center">会员等级要求</td>
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="tableborder">
  <tr>
    <td height="25" colspan="11" align="center" class="tdtitle">农场物品设置</td>
  </tr>
  <tr align="center"> 
...
每天生产金币：<?php echo $val['h_point2Day']; ?><br />
...
农场最大存在：<?php echo $val['h_allMaxNum']; ?><br /></td>
